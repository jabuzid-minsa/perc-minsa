...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { code: @network.code, description: @network.description, geography_id: @network.geography_id, state: @network.state }
    end
  ...
  test "should update network" do
    patch :update, id: @network, network: { code: @network.code, description: @network.description, geography_id: @network.geography_id, state: @network.state }
    assert_redirected_to network_path(assigns(:network))
  end
