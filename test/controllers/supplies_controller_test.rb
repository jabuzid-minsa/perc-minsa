...
class SuppliesControllerTest < ActionController::TestCase
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post :create, supply: { code: @supply.code, description: @supply.description, geography_id: @supply.geography_id, language_id: @supply.language_id, state: @supply.state, supply_id: @supply.supply_id }
    end
  ...
  test "should update supply" do
    patch :update, id: @supply, supply: { code: @supply.code, description: @supply.description, geography_id: @supply.geography_id, language_id: @supply.language_id, state: @supply.state, supply_id: @supply.supply_id }
    assert_redirected_to supply_path(assigns(:supply))
  end
